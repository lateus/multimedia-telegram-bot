...
from src.plugins.rename import media_rename
from src.plugins.compressor import compress
from src.plugins.trimmer import trim
from src.plugins.convertor import mp3, flac, wav, mp4, mkv, webm, file, video
from src.plugins.encoder import encode
from src.plugins.ssgen import screenshot
